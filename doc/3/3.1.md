...
---
__Tracking Django development__
...
假如你决定使用最新的Django开发版本，你需要密切关注开发版的时间线，并且时刻关注即将发布的发布文档。这将帮助您掌握任何您可能想要使用的新功能，以及更新Django副本时需要对代码所做的任何更改。（对于稳定发布版，任何更改都将写进发布文档）
...
如果你希望更新Django代码来偶尔修复最新bug和提高，按照如下指导:
...
1. 确保你安装了git并且可以在shell在执行命令（在shell提示符下输入git help 测试一下）