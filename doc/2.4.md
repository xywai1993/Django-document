...
点击“Questions”，现在你在 questions 的“改变列表”页。这页面显示了所有数据库里的问题，选择其中一个修改它。这而是我们之前创建的“What’s up?”问题
...
-   不同的模型字段（DateTimeField, CharField）对应相应的 HTML 表单组件。每个字段知道如何显示自己在 Django 后台
...
点击 “今天”和“现在”快捷按钮修改“发布日期”。然后点击“保存并且继续编辑”。然后点击右上方的“历史”。你会看到一个列有管理员对此对象做的所有更改记录的页面，伴有修改时间戳和修改人的用户名
